...
<div class="row input-group mb-3">
  ...
  <div class="col-sm-6">
    <input type="text" class="form-control" name="employee_name" value="<?= $info['employee_info']->names; ?>" readonly>
  </div>
...
<div class="row input-group mb-3">
  ...
  <div class="col-sm-4">
    <input type="text" name="jina_la_msimamizi" class="form-control" value="<?= $this->session->userdata('full_name'); ?>" readonly>
  </div>
</div>
...
<div class="card-title text-center">
  ...
  <table class="table table-bordered border-primary text-center">
    ...
    <tbody>
      <tr>
        ...
        <td><input class="col-md-8 text-center" name="mahusiano_kazini_1_msimamizi" type="number" required min="1" max="5"></td>
        <td><input class="col-md-8 text-center" name="mahusiano_kazini_1_maafikiano" type="number" required min="1" max="5"></td>                          
      </tr>
      <tr>
        ...
        <td><input class="col-md-8 text-center" name="mahusiano_kazini_2_msimamizi" type="number" required min="1" max="5" ></td>
        <td><input class="col-md-8 text-center" name="mahusiano_kazini_2_maafikiano" type="number" required min="1" max="5"></td>                          
      </tr>
      <tr>
        ...
        <td><input class="col-md-8 text-center" name="mahusiano_kazini_3_msimamizi" type="number" required min="1" max="5"></td>
        <td><input class="col-md-8 text-center" name="mahusiano_kazini_3_maafikiano" type="number" required min="1" max="5"></td>                       
      </tr>
      ...
      <tr>
        ...
        <td><input class="col-md-8 text-center" name="mawasiliano_na_usikivu_1_msimamizi" type="number" required min="1" max="5"></td>
        <td><input class="col-md-8 text-center" name="mawasiliano_na_usikivu_1_maafikiano" type="number" required min="1" max="5"></td>                         
      </tr>
      <tr>
        ...
        <td><input class="col-md-8 text-center" name="mawasiliano_na_usikivu_2_msimamizi" type="number" required min="1" max="5"></td>
        <td><input class="col-md-8 text-center" name="mawasiliano_na_usikivu_2_maafikiano" type="number" required min="1" max="5"></td>                           
      </tr>
      <tr>
        ...
        <td><input class="col-md-8 text-center" name="mawasiliano_na_usikivu_3_msimamizi" type="number" required min="1" max="5"></td>
        <td><input class="col-md-8 text-center" name="mawasiliano_na_usikivu_3_maafikiano" type="number" required min="1" max="5" ></td>                           
      </tr>
      <tr>
        ...
        <td><input class="col-md-8 text-center" name="mawasiliano_na_usikivu_4_msimaizi" type="number" required min="1" max="5" ></td>
        <td><input class="col-md-8 text-center" name="mawasiliano_na_usikivu_4_maafikiano" type="number" required min="1" max="5" ></td>                           
      </tr>
      ...
      <tr>
        ...
        <td><input class="col-md-8 text-center" name="uongozi_na_usimamizi_1_msimamizi" type="number" required min="1" max="5" ></td>
        <td><input class="col-md-8 text-center" name="uongozi_na_usimamizi_1_maafikiano" type="number" required min="1" max="5" ></td>                          
      </tr>
      <tr>
        ...
        <td><input class="col-md-8 text-center" name="uongozi_na_usimamizi__2_msimamizi" type="number" required min="1" max="5" ></td>
        <td><input class="col-md-8 text-center" name="uongozi_na_usimamizi__2_maafikiano" type="number" required min="1" max="5" ></td>                         
      </tr>
      <tr>
        ...
        <td><input class="col-md-8 text-center" name="uongozi_na_usimamizi_3_msimamizi" type="number" required min="1" max="5"></td>
        <td><input class="col-md-8 text-center" name="uongozi_na_usimamizi_3_maafikiano" type="number" required min="1" max="5" ></td>                          
      </tr>
      ...
      <tr>
        ...
        <td><input class="col-md-8 text-center" name="ubora_na_utendaji_1_msimamizi" type="number" required min="1" max="5" ></td>
        <td><input class="col-md-8 text-center" name="ubora_na_utendaji_1_maafikiano" type="number" required min="1" max="5"></td>                          
      </tr>
      <tr>
        ...
        <td><input class="col-md-8 text-center" name="ubora_na_utendaji_2_msimamizi" type="number" required min="1" max="5" ></td>
        <td><input class="col-md-8 text-center" name="ubora_na_utendaji_2_maafikiano" type="number" required min="1" max="5" ></td>                          
      </tr>
      ...
      <tr>
        ...
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="utendaji_wa_wingi_wa_matokeo_1_msimamizi" ></td>
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="utendaji_wa_wingi_wa_matokeo_1_maafikiano"></td>                        
      </tr>
      <tr>
        ...
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="utendaji_wa_wingi_wa_matokeo_2_msimamizi"></td>
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="utendaji_wa_wingi_wa_matokeo_2_maafikiano"></td>                          
      </tr>
      ...
      <tr>
        ...
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uajibikaji_utoaji_maamuzi_1_msimamizi"></td>
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uajibikaji_utoaji_maamuzi_1_maafikiano"></td>                          
      </tr>
      <tr>
        ...
        <td><input type="text" class="col-md-8 text-center" name="" value="<?= $info['performance_info']->uajibikaji_utoaji_maamuzi_2_mtumishi; ?>" readonly></td>
         <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uajibikaji_utoaji_maamuzi_2_msimamizi"></td>
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uajibikaji_utoaji_maamuzi_2_maafikiano"></td>                          
      </tr>
      ...
      <tr>
        ...
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="kuthamini_wateja_1_msimamizi"></td>
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="kuthamini_wateja_1_maafikiano"></td>                         
      </tr>
      ...
      <tr>
        ...
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uaminifu_1_msimamizi"></td>
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uaminifu_1_maafikiano"></td>                         
      </tr>
      <tr>
        ...
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uaminifu_2_msimamizi" ></td>
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uaminifu_2_maafikiano" ></td>                        
      </tr>
      <tr>
        ...
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uaminifu_3_msimamizi" ></td>
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uaminifu_3_maafikiano"></td>                         
      </tr>
      ...
      <tr>
        ...
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uadilifu_1_msimamizi"></td>
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uadilifu_1_maafikiano"></td>                          
      </tr>
      <tr>
        ...
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uadilifu_2_msimamizi"></td>
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uadilifu_2_maafikiano"></td>                          
      </tr>
      <tr>
        ...
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uadilifu_3_msimamizi"></td>
        <td><input type="number" required min="1" max="5"  class="col-md-8 text-center" name="uadilifu_3_maafikiano" ></td>                          
      </tr>
      <tr>
  ...
  <div class="row input-group mb-3">
    <label for="hd_names" class="col-sm-2 col-form-label">Jina la Msimamizi</label>
      <div class="col-sm-5">
        <input type="text" class="form-control" value="<?= $this->session->userdata('full_name'); ?>" readonly>
      </div>
  ...
  <div class="row input-group mb-3">
    <label for="hd_names" class="col-sm-2 col-form-label">Jina La MENEJA</label>
      <div class="col-sm-5">
        <input type="text" class="form-control" name="hr_name" readonly>
      </div>
    <label for="tarehe" class="col-sm-2 col-form-label">Tarehe</label>
      <div class="col-sm-3">
