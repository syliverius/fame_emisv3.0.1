...
<div class="card-title text-center">
  ...
  <div class="row input-group mb-3">
    <label for="wastani" class="col-sm-2 col-form-label">WASTANI</label>
      <div class="col-sm-5">  
        <input type="text" class="form-control" value="<?= round((($sum1+$sum2+$sum3)/69),1); ?>" readonly>
      </div>
  </div>
  ...
  <div class="row input-group mb-3">
    <div class="col-sm-12">
      <textarea class="form-control" cols="2" readonly><?= $info['performance_info']->maoni_ya_hr; ?></textarea>
    </div>
  </div>
  ...
  <div class="row input-group mb-3">
    <label for="hd_names" class="col-sm-2 col-form-label">Jina La MENEJA</label>
      <div class="col-sm-5">
        <input type="text" class="form-control"  value="<?= $info['performance_info']->hr_name; ?>" readonly>
      </div>
    <label for="tarehe" class="col-sm-2 col-form-label">Tarehe</label>
      <div class="col-sm-3">
        <input type="date" class="form-control" name="tarehe" value="<?= $info['performance_info']->hr_sign_date; ?>" readonly>
      </div>
    </div>
