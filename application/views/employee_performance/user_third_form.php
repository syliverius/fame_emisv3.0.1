    ...
    <div class="card-body">
        ...
        <form id="performance_form3" method="post">
          ...
          <div class="row input-group mb-3">
            ...
            <div class="col-sm-5">
              <input type="text" class="form-control"  name="wastani"  readonly>
            </div>
          </div>
          ...
          <div class="row input-group mb-3">
            <div class="col-sm-12">
              <textarea class="form-control" cols="2" name="tuzo" readonly></textarea>
            </div>
          </div>
          ...
          <div class="row input-group mb-3">
            ...
            <div class="col-sm-8">
              <textarea class="form-control" cols="2" name="hd_maoni" readonly></textarea>
            </div>
          </div>
          ...
          <div class="row input-group mb-3">
            ...
            <div class="col-sm-5">
              <input type="text" class="form-control"  name="hd_names"  readonly>
            </div>
          ...
          <div class="row input-group mb-3">
            ...
            <div class="text-center">
              <button type="button" class="btn btn-primary" onclick="process_third_form()">Complete</button>
