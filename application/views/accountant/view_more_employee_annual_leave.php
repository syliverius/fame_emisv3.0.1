...
<div class="modal-body row g-3">
	...
	<div class="col-md-12">
	    ...
	    <input type="number" class="form-control" name="days" id="days" value="<?= $leave_info->days_off; ?>" readonly>
	     <span id="error_message" style="color: red;"></span>
	</div>
	
	<div class="col-md-4">
	    <label for="start_date">Kuanzia Tarehe</label>
	    <input type="date" class="form-control" name="start_date" id="leave_start_date" value="<?= $leave_info->start_date; ?>" readonly>
	</div>
	...
	<div class="col-md-5">
	    ...
	    <input type="text" class="form-control" name="dept_head_name" value="<?= $this->admin->getDepartmentHeadinfo($leave_info->hr_id)->names;?>" readonly>
	</div><!--bad coding here as the HR department is hardcoded -->

	<div class="col-md-2">
	    <label for="tarehe">Tarehe</label>
	    <input type="text" class="form-control" name="date" value="<?= $leave_info->hr_sign_date; ?>" readonly>
	</div>

	<div class="col-md-5">
		<label for="exampleTextarea1">Hr's Comments</label>
		<textarea class="form-control" id="comments" name="comments" rows="2" readonly><?= $leave_info->hr_comment; ?></textarea>
	</div>
</div>
