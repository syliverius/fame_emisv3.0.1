...
<body class='body-bg'>
    ...
    <header class='shadow' style="margin-bottom:5em">
	<!-- Navigation -->
    <nav class="header-nav navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse header_menu container_head_menu" id="bs-example-navbar-collapse-1" >
                <ul class="nav navbar-nav ">
					...
					<li class="header_list <?php if($tab=='POST JOB')  { ?>active <?php } ?>"><a href="<?php echo base_url();?>post_job" class="menu_item" id="about">POST JOBS</a></li>
					<?php if(!$this->session->userdata('user')){ ?>
					<li class="header_list <?php if($tab=='LOGIN')  { ?>active <?php } ?>"><a href="<?php echo base_url();?>login" class="menu_item" id="about">LOGIN/REGISTER</a></li>
					<?php } else { ?>
