...
<div class="card" id="">
  <div class="card-body">
    <div id="print_table">
    <div class="card-title text-center"><?= $data['month'];?> - <?= $data['year']; ?> <?= $this->session->userdata('department_name');?> DUTY ROSTER </div>
    	...
    	<table id="myTable">
		  <?php
    		...
    		<tbody>
                ...
                <?php 
                       $i = 1; 
                       $shifts = $data['current_shifts']; 
                       $color;
                       ?>
                       <tr>
                        <td class="col-sm-5"><b><?= $this->session->userdata('full_name'); ?></b></td>
                        <?php foreach ($shifts as $shift) { 
                           ...
                           <td style="background-color: #<?= $color; ?> "><?= $shift->shift_type_abbrev; ?></td> 
                            <?php $i++; } ?>
                       </tr>
    		 </tbody>
             <tfoot>
                        ...
                        <tr>
                            <td ><?= $this->session->userdata('full_name'); ?></td>
                                <?php 
                                    foreach($data['shifts'] as $shifts){
                                        $count = 0;
                                        foreach($data['current_shifts'] as $row){
