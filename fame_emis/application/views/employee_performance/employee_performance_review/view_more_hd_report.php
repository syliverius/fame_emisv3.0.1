...
<div class="row input-group mb-3">
  ...
  <div class="col-sm-5">
    <input type="text" class="form-control" value="<?= $this->session->userdata('department_name'); ?>" readonly>
  </div>
</div>
...
<div class="row input-group mb-3">
  ...
  <div class="col-sm-4">
    <input type="text" class="form-control" value="<?= $info['head_info']->names; ?>" readonly>
  </div>
</div>
