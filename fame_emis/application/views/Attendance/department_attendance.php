        ...
        <div class="card">
          <div class="card-body">
            <div class="card-title">Weekly Attendance Report</div>
              <!-- Settings Form -->
                <form id="dept_attendance_report">
                  <input type="text" name="department" value="<?= $this->session->department_id; ?>" hidden>
                    <div class="row mb-3">
...
<script type="text/javascript" language="javascript">
  ...
  function create_weekly_attendance_report(e){
    e.preventDefault();
    var data = $("#dept_attendance_report").serialize();                
      $.ajax({               
        type : 'POST',
        ...
        success : function(response){ 
          $('#dept_weekly_report').html(response);
          }
        });
        return false;
  }
